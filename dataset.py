"""
Bilingual Dataset Handler for Neural Machine Translation
...
This module handles the preprocessing and loading of parallel corpora for 
translation tasks. It creates proper input/output pairs with appropriate 
masking for the Transformer model.

Key Features:
- Bilingual dataset processing
- Proper tokenization with special tokens (SOS, EOS, PAD)
